...
class Land_for_industries extends CI_controller {
    ...
    public function index(){
        ...
        redirect(site_url('land_for_agro/all'));
    ...
    public function all(){
        ...
        $config['base_url'] = base_url() . 'land_for_industries/all';
        ...
        $data['page'] = "front/pages/land_for_industries";
