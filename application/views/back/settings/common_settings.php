                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col col-lg-4">
                                <img id="previewImg1" src="<?=base_url()?>assets/img/logo/<?=$list[0]->logo?>" width="130px" />
                                <script>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" placeholder="e.g: 999-99999" name="hot_phn" value="<?=$list[0]->hot_phn?>" required>
                            </div>
                        </div>
                        <!-- copy -->
                        <div class="form-group">
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="e.g: http://www.facebook.com/page" name="fb" value="<?=$list[0]->fb?>" required>
                                </div>
                            </div>
                            <!-- link -->
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="e.g: http://www.twitter.com/page" name="twt" value="<?=$list[0]->twt?>" required>
                                </div>
                            </div>
                            <!-- link -->
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="e.g: http://www.linkdein.com/page" name="link" value="<?=$list[0]->link?>" required>
                                </div>
                            </div>
                            <!-- link -->
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> Google plus<sup style="color: red">*</sup></label>
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="e.g: http://www.google.com/page" name="g_plus" value="<?=$list[0]->g_plus?>" required>
                                </div>
                            </div>
                        </div>
                </div><!-- /.box -->
