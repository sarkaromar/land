...
<html>
    <head>
        ...
        <!-- notify -->
        <link rel="stylesheet" href="<?=base_url()?>assets/back/css/noti_css/notify.css">
        <link rel="stylesheet" href="<?=base_url()?>assets/back/css/noti_css/prettify.css">
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown messages-menu">
                                <a href="<?=site_url()?>" class="dropdown-toggle" title="View Site" target="_blank"><i class="fa fa-fw fa-home"></i> View Site</a>
                            </li>
                            <!-- user account -->
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        <img src="<?=base_url()?>assets/back/img/profile/<?php echo $this->back_user->info->avatar ?>" class="img-circle" alt="User Image">
                                        <p>
