                    ...
                    <?php echo form_open_multipart(site_url("admin_panel/add_slider"), array("class" => "form-horizontal")) ?>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="e.g: anything" name="info_01" >
                                </div>
                            </div>
                            <!-- info 2 -->
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="e.g: anything" name="info_02" >
                                </div>
                            </div>
                            <!-- info 3 -->
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="e.g: anything" name="info_03" >
                                </div>
                            </div>
                            <!-- info 4 -->
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="e.g: anything" name="info_04" >
                                </div>
                            </div>
                            <!-- image -->
                            <div class="form-group">
