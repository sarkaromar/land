                ...
                <div class="box">
                    ...
                    <?php echo form_open_multipart(site_url("admin_panel/do_edit_slider"), array("class" => "form-horizontal")) ?>
                        <div class="box-body">
                            ...
                            <!-- info 1 -->
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> Addit. info. 01<sup style="color: red">*</sup></label>
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="e.g: anything" name="info_01" value="<?=$list[0]->info_01?>" >
                                </div>
                            </div>
                            <!-- info 2 -->
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> Addit. info. 02<sup style="color: red">*</sup></label>
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="e.g: anything" name="info_02" value="<?=$list[0]->info_02?>" >
                                </div>
                            </div>
                            <!-- info 3 -->
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> Addit. info. 03<sup style="color: red">*</sup></label>
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="e.g: anything" name="info_03" value="<?=$list[0]->info_03?>" >
                                </div>
                            </div>
                            <!-- info 4 -->
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> Addit. info. 04<sup style="color: red">*</sup></label>
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="e.g: anything" name="info_04" value="<?=$list[0]->info_04?>" >
                                </div>
                            </div>
                            <!-- image -->
                            <div class="form-group">
