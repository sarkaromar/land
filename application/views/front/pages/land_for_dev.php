            ...
            <div class="MultiCarousel-inner">
                <?php if(empty($this->area->lists)) {?>
                    ...
                    <?php foreach($this->area->lists as $area_list) : ?>
                        ...
                        <div class="item">
                                <div class="pad15">
                                    <a href="#"><img class="mul_slide_img" src="<?=base_url()?>assets/img/area/<?=$area_list->image?>" alt="<?=$area_list->image?>"></a>
                                    <a href="#"><span><i class="fa fa-map-marker"></i> <?=$area_list->area?></span></a>
                                </div>
                        </div>
            ...
            <div class="properties_item row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 single_properties">
                    ...
                    <div class="text">
                        ...
                        <a class="tran3s" href="<?=base_url()?>land_for_development/details/<?=$list->id?>" >View Package</a>
                    </div> <!-- End .text -->
